...
from net import net_arch, ensemble_arch
...
class NeuralNet(object):
    ...
    def __compute_train_matrics(self, batch_x, batch_y, batch_index, data_len, accuracy, cost):
    ...
    def training(self, x_train, y_train, x_val, y_val):
        ...
        for epoch in range(self.epochs):
            ...
            for batch_index in range(len(x_train) // self.batch_size):
                ...
                train_loss_batch, train_accuracy_batch = self.__compute_train_matrics(batch_x, batch_y,
                                                                                      batch_index,
